...
import 'package:dummymart/ui/views/product/product_view.dart' as _i4;
import 'package:dummymart/ui/views/products/products_view.dart' as _i3;
import 'package:dummymart/ui/views/startup/startup_view.dart' as _i2;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i3.ProductsView: (data) {
      return _i5.MaterialPageRoute<dynamic>(
        builder: (context) => const _i3.ProductsView(),
        settings: data,
      );
    },
    _i4.ProductView: (data) {
      ...
      return _i5.MaterialPageRoute<dynamic>(
        builder: (context) => _i4.ProductView(key: args.key, id: args.id),
        settings: data,
      );
    },
  };
...
extension NavigatorStateExtension on _i6.NavigationService {
  ...
  Future<dynamic> navigateToProductView({
    ...
    return navigateTo<dynamic>(Routes.productView,
        arguments: ProductViewArguments(key: key, id: id),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
