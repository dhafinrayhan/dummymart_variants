...
// in dummymart/test/helpers/test_helpers.dart.
...
import 'package:dummymart/models/product.dart' as _i2;
import 'package:dummymart/services/api_service.dart' as _i8;
...
class MockApiService extends _i1.Mock implements _i8.ApiService {
  @override
  _i6.Future<List<_i2.Product>> fetchProducts() => (super.noSuchMethod(
        Invocation.method(
          #fetchProducts,
          [],
        ),
  ...
  @override
  _i6.Future<_i2.Product> fetchProduct(int? id) => (super.noSuchMethod(
        Invocation.method(
          #fetchProduct,
          [id],
        ),
